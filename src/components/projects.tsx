...
export default function Projects() {
  ...
  const webProjects = [
    ...
    },
    {
      id: 3,
      images: [
        'projectspics/KabsuDripkabsudrip (1).png',
        'projectspics/KabsuDripkabsudrip (2).png',
        'projectspics/KabsuDripkabsudrip (3).png',
        'projectspics/KabsuDripkabsudrip (4).png',
        'projectspics/KabsuDripkabsudrip (5).png',
        'projectspics/KabsuDripkabsudrip (6).png',
        'projectspics/KabsuDripkabsudrip (7).png',
        'projectspics/KabsuDripkabsudrip (8).png',
        'projectspics/KabsuDripkabsudrip (9).png',
        'projectspics/KabsuDripkabsudrip (10).png',
        'projectspics/KabsuDripkabsudrip (11).png',
        'projectspics/KabsuDripkabsudrip (12).png',
        'projectspics/KabsuDripkabsudrip (13).png',
      ],
